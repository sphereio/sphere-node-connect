...
exports.Rest = function(opts) {
  var config, oauth_options, rejectUnauthorized;
  if (opts == null) {
    opts = {};
  }
  config = opts.config;
...
exports.Rest.prototype.GET = function(resource, callback) {
  ...
  return exports.preRequest(this._oauth, this._options, params, callback);
};
...
exports.preRequest = function(oa, options, params, callback) {
  var _req;
  _req = function(retry) {
    var request_options;
